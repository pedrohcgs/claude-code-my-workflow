...
import delimited "D:\Kikis Stuff\University of Wisconsin\Year 2\Project Assistant\data\InputSurvey-fert_questions.csv", rowrange(13:) clear
...
import delimited "D:\Kikis Stuff\University of Wisconsin\Year 2\Project Assistant\data\InputSurvey.csv", rowrange(5:) clear
...
keep id county store_name formdef_version fert_type_id fert_type_label current_stock manuf_n manuf_number manufacturer manufacturero manuf_name price purchase_unit_large price_small purchase_unit bag_size* gpslatitude gpslongitude
