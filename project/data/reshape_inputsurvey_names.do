...
import delimited "$dir\data\InputSurvey-names", clear


save "InputSurvey_names.dta", replace
...
merge 1:m parent_key using "InputSurvey_names.dta", nogen
sort id key
...
*Label Other Business Names Data*
label variable other_business "Does the owner of business also own other agrovets or stores that sell fertilizer?"
label values other_business yesno
label variable other_business2 "How many other businesses does the owner own?"

order biz_nr-key, after(setofnames)
drop key
...
save "inputsurvey_otherbusinesses.dta", replace
