...
* global dir "C:\Users\etjernstrom\Dropbox\Fake fertilizer\PEDL\data"
cd "$dir"
* **********

* assumes
	* geodist
log using "$dir/build/output/ff_stores_distance", replace

use "$dir\build/output\manufacturer_fertilizer.dta", clear
...
lab val bus_typeD business_type
...
save "$dir/build/temp/addvars.dta", replace
merge 1:m id using "$dir\build/output\MysteryShopping_all.dta"

save "$dir/build/output/mystery_addvars.dta", replace
