...
log using "$dir/data/mysteryshopping_import_clean", replace
...
save "$dir\data\MysteryShopping.dta", replace

*Import Label Ids*
import delimited "$dir\data\label_ids.csv", clear

merge 1:1 num using "$dir\data\MysteryShopping.dta", nogen
drop num
...
**Need to address duplicates--some enumerators entered the sealed bag information twice
...
save "$dir\data\MysteryShopping_clean.dta", replace
