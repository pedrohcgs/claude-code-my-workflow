...
import delimited "$dir\data\InputSurvey-fert_questions.csv", rowrange(13:) clear
...
save "$dir\data\InputSurvey-fert_questions1.dta", replace
...
merge 1:m parent_key using "$dir\data\InputSurvey-fert_questions1.dta"
...
save "$dir\data\manufacturer_fertilizer.dta", replace
