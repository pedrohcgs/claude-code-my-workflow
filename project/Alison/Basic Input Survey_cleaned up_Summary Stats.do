...
hist within_5, discrete percent kdensity scheme(s1mono) xtitle("Percent of stores within 5 km of another store")
hist within_5, percent kdensity scheme(s1mono) xtitle("Percent of stores within 5 km of another store")
