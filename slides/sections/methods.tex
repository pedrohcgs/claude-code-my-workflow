...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth,height=0.7\textheight,keepaspectratio]{../tasks/figures_and_tables/output/fig_sensitivity_range.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth,height=0.7\textheight,keepaspectratio]{../tasks/figures_and_tables/output/fig_labor_share_bar.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.82\textwidth,height=0.58\textheight,keepaspectratio]{../tasks/figures_and_tables/output/fig_healthcare_subsectors.png}
\end{figure}
