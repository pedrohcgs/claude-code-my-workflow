...
log using "outputs/sensitivity_analysis.log", replace
...
compress
save "outputs/sensitivity_results.dta", replace
...
capture {
    ...
    * manual formatting or esttab with stored estimates.
    export delimited using "outputs/sensitivity_summary.csv", replace

    * Create a basic LaTeX table
    file open tex using "outputs/sensitivity_summary.tex", write replace
...
use "outputs/sensitivity_results.dta", clear
...
* Check outputs exist
capture confirm file "outputs/sensitivity_summary.tex"
if _rc == 0 {
