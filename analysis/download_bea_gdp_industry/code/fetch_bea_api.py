...
Requires:
    - BEA API key in ../inputs/bea_api_key.txt
...
def read_api_key():
    """Read BEA API key from inputs directory."""
    key_file = os.path.join(INPUTS_DIR, "bea_api_key.txt")
...
def main():
    ...
    inventory_path = os.path.join(OUTPUTS_DIR, "bea_table_inventory.txt")
    ...
    va_path = os.path.join(OUTPUTS_DIR, "bea_va_components.csv")
    ...
    chain_path = os.path.join(OUTPUTS_DIR, "bea_chain_indexes.csv")
