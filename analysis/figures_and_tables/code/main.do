...
log using "outputs/figures_and_tables.log", replace
...
use "inputs/factor_shares/factor_shares_adjusted.dta", clear
...
graph export "outputs/fig_labor_share_timeseries.png", ///
...
graph export "outputs/fig_capital_share_timeseries.png", ///
    width(`gwidth') height(`gheight') replace
...
graph export "outputs/fig_healthcare_subsectors.png", ///
    width(`gwidth') height(`gheight') replace
...
graph export "outputs/fig_labor_share_bar.png", ///
    width(`gwidth') height(`gheight') replace
...
use "inputs/sensitivity/sensitivity_results.dta", clear
...
capture {
    ...
    graph export "outputs/fig_sensitivity_range.png", ///
        width(`gwidth') height(`gheight') replace
}
if _rc != 0 {
...
capture {
    use "inputs/bea_bls_merged/merged_bea_bls_panel.dta", clear
    ...
    * Collapse to one row per industry
    ...
    graph export "outputs/fig_employment_vs_share.png", ///
        width(`gwidth') height(`gheight') replace
...
capture {
    ...
    * Export as LaTeX
    ...
    listtex naics_code industry_group labor_share_raw capital_share_raw ///
        ...
        using "outputs/tab_factor_shares_summary.tex", ///
...
if _rc != 0 {
    ...
    * Fallback: manual LaTeX generation
    file open tex using "outputs/tab_factor_shares_summary.tex", write replace
...
capture confirm file "inputs/sensitivity/sensitivity_summary.tex"
if _rc == 0 {
    copy "inputs/sensitivity/sensitivity_summary.tex" ///
        "outputs/tab_sensitivity_summary.tex", replace
...
foreach fig in fig_labor_share_timeseries fig_capital_share_timeseries ///
    ...
    capture confirm file "outputs/`fig'.png"
    if _rc == 0 {
        display "  `fig'.png: OK"
    }
    else {
...
capture confirm file "outputs/fig_employment_vs_share.png"
if _rc == 0 {
...
foreach tab in tab_factor_shares_summary {
    capture confirm file "outputs/`tab'.tex"
    if _rc == 0 {
        display "  `tab'.tex: OK"
    }
    else {
