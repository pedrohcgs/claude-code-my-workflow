...
log using "outputs/download_bea_nipa_supplements.log", replace
...
capture confirm file "../download_bea_gdp_industry/inputs/bea_api_key.txt"
if _rc == 0 {
    local key_found = 1
}
if `key_found' == 0 {
    ...
    display as error "Or at: ../download_bea_gdp_industry/inputs/bea_api_key.txt"
    log close
    error 601
}

* --- 2. Run Python helper ---
capture confirm file "outputs/nipa_proprietors_income.csv"
...
if _rc == 0 {
    ...
    import delimited using "outputs/nipa_proprietors_income.csv", clear varnames(1) stringcols(_all)
    ...
    * Clean values
    ...
    compress
    save "outputs/proprietors_income_by_industry_raw.dta", replace
}
else {
...
capture confirm file "outputs/nipa_cfc.csv"
if _rc == 0 {
    display _n "Importing consumption of fixed capital by industry..."
    import delimited using "outputs/nipa_cfc.csv", clear varnames(1) stringcols(_all)
    ...
    compress
    save "outputs/cfc_by_industry_raw.dta", replace
}
else {
...
capture confirm file "outputs/proprietors_income_by_industry_raw.dta"
if _rc == 0 {
    use "outputs/proprietors_income_by_industry_raw.dta", clear
...
capture confirm file "outputs/cfc_by_industry_raw.dta"
if _rc == 0 {
    use "outputs/cfc_by_industry_raw.dta", clear
