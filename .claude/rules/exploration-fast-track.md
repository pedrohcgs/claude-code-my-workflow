...
This rule is the explicit exception to `plan-first-workflow.md` for work that stays entirely inside `explorations/**`.
...
3. **Code immediately** -- no formal plan needed for exploration-only work. Must-haves: code runs, results correct, goal documented. Not needed: Roxygen docs, full tests, perfect style.
