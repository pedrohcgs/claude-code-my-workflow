...
Requires:
    - BEA API key in ../../download_bea_gdp_industry/input/bea_api_key.txt
...
API_KEY_PATH = os.path.join(
    SCRIPT_DIR, "..", "..", "download_bea_gdp_industry", "input", "bea_api_key.txt"
)
...
def read_api_key():
    ...
    local_key = os.path.join(INPUT_DIR, "bea_api_key.txt")
...
def main():
    ...
    inventory_path = os.path.join(OUTPUT_DIR, "nipa_table_inventory.txt")
    ...
    prop_path = os.path.join(OUTPUT_DIR, "nipa_proprietors_income.csv")
    ...
    cfc_path = os.path.join(OUTPUT_DIR, "nipa_cfc.csv")
