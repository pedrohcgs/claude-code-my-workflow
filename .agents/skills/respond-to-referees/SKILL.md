...
3. **Spawn the `claim-verifier` subagent** with the claims table, the verification questions, and the path to the revised manuscript. Do NOT include the response draft.
