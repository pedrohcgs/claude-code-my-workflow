...
Fact-check a draft using the **Post-Flight Verification protocol** ([`.claude/rules/post-flight-verification.md`](../../../.claude/rules/post-flight-verification.md)).
...
```
Spawn the `claim-verifier` subagent with the claims table, verification questions, and source-material pointers.
...
- [`.codex/agents/claim-verifier.toml`](../../../.codex/agents/claim-verifier.toml) — the forked verifier.
- [`.claude/rules/post-flight-verification.md`](../../../.claude/rules/post-flight-verification.md) — the protocol.
