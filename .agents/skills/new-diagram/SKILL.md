...
Spawn the `tikz-reviewer` subagent. Pass the `.tex` source and the compiled `.pdf` path. The reviewer is required to cite the pass and formula from [`.claude/rules/tikz-measurement.md`](../../../.claude/rules/tikz-measurement.md) for every CRITICAL/MAJOR finding — vague reports are rejected.
...
- [`.claude/rules/tikz-prevention.md`](../../../.claude/rules/tikz-prevention.md) — the P1–P6 authoring rules.
- [`.claude/rules/tikz-measurement.md`](../../../.claude/rules/tikz-measurement.md) — the six-pass protocol with formulas the reviewer cites.
- [`.claude/rules/tikz-visual-quality.md`](../../../.claude/rules/tikz-visual-quality.md) — general visual standards.
